...
async def main_buttons():
    ...
    if branding['enabled'] and branding['url']:
        buttons.append([InlineKeyboardButton('👨‍💻 Developer', url=branding['url'])])
    buttons.append([
        InlineKeyboardButton('📥 Source Setup', callback_data='source#menu'),
        InlineKeyboardButton('📤 Destination Setup', callback_data='dest#menu')
    ])
    buttons.append([
        InlineKeyboardButton('👨‍💻 ʜᴇʟᴘ', callback_data='help'),
        InlineKeyboardButton('💁 ᴀʙᴏᴜᴛ', callback_data='about')
    ])
    buttons.append([InlineKeyboardButton('⚙ sᴇᴛᴛɪɴɢs', callback_data='settings#main')])
...
async def start(client, message):
    ...
    reply_markup = await main_buttons()
